  ...
  render() {
    ...
    const aboutEl = (
      ...
      >
        ...
        <div className="About__ConentWrapper"></div>
        <div className="About__Content">
          ...
          <p style={{ color: "#0000ff" }}>
            ...
            Appendages transform. Colour is revised. Portals open up, limbs are
            put part way through, and then all the way through, and new bodies
            are observed and created.
          </p>
          <p style={{ color: "#007000" }}>
            ...
            work and as an interactive installation for the 2021 Vancouver Comic
            Arts Festival. Originally conceived as an in-person project in 2020,
            the Lounge transformed into an online space after that edition of
            VANCAF was cancelled.
          </p>
          <p style={{ color: "#f0295e" }}>
            Puddle Popper is an artist collective formed in 2015 in Vancouver by
            artists Sarah Davidson, Juli Majer, Sonja Ratkay and Mel Thibodeau.
            Through interactive sculpture installations, we propose alternate
            spaces in which bodies both human and non-human interact: themes of
            embodiment, comfort, queerness, and ecology are the basis for
            playful, collaborative world-building.
          </p>
          <p style={{ color: "#0000ff" }}>
          ...
          <p style={{ color: "#0000ff" }}>
            ...
            works primarily between drawing and painting to create compositions
            in which shadowy, biomorphic figures and delicate, foliated
            fragments mingle. While she often draws directly from ‘nature’, her
            drawings diffract distinctions between embodied self and other
            through a queer ecological lens: critters and space collapse in upon
            one another, suggesting a permeable web. Both the eye and the mind
            work towards the known--animals, plants, brush marks, lines--but are
            caught in a space of undoing. In swampy, saturated tones, her works
            wonder: who’s looking at who, and how?
          </p>

          <p style={{ color: "#007000" }}>
            <strong>
              <a target="_blank" href="http://julimajer.net/" rel="noreferrer">
                JULI MAJER
              </a>
            </strong>{" "}
            ...
            sculpture, and comics, Majer weaves together visceral abstractions,
            somatic sensations, and inarticulate textures which emerge from
            relationships between her characters, symbols, objects, and
            environments.
          </p>
          ...
          <p style={{ color: "#f0295e" }}>
            ...
            navigates unconscious and conscious drives through which she aims to
            process thoughts alongside viewers. Ratkay’s bodily art exists on
            the threshold of interior and exterior realms, and evokes liminal
            states of being, populated by known and unknown symbols. Her work
            spans many mediums from ink drawings, to multi-sensory
            elements--such as smell--that are known to trigger memories, and
            most recently textile works. Through repetition of motifs including
            abstracted bodies and text-as-image, she creates choreographed
            movements between body and mind, a pathway for feelings and thoughts
            to travel.
          </p>

          <p style={{ color: "#0000ff" }}>
            Through tactile sculptures meant to be both observed and interacted
            with,{" "}
            <strong>
              <a
                target="_blank"
            ...
            half-recognizable body parts, eluding exact description and hovering
            somewhere between person and thing. These partial and abstracted
            forms unsettle gender, wink at desire, and ponder fleshy realities
